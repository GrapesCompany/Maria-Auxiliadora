    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <div class="fadeIn first">
                <img src="https://i.pinimg.com/originals/9d/9b/ab/9d9bab48cbb3a5de959ab844b3e9712d.gif" id="icon" alt="User Icon" />
            </div>
            ...
            <form name="nform" action="login.php" method="post">
                ...
                <input type="button" class="fadeIn fourth" value="Entrar" onClick="enviar('/pan.php')">
            </form>
