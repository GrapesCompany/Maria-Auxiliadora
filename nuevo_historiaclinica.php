...
$pep = '<div class="container">
 ...
 <div class="card mb-3">
            <div class="card-header text-center">
              ...
              Detalle de Historia Clínica</div><br>
            <div class="container">
 ...
 <div class="form-row">
   ...
   <div class="col-md-4">
   <div class="form-label-group">
   <input type="mail" id="correo" name="correo" class="form-control" placeholder="Correo electrónico" required="required">
...
<div class="card mb-3">
 ...
 <button  class="btn btn-block col-md-2 btn-ttc" href="login.html">Guardar</button>
 
 </div>
 <br>
 <div class="card-footer small text-muted">Historia Clínica</div>
 </div>
